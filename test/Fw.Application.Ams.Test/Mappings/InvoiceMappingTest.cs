...
using Fw.Application.Ams.Mappings;
...
namespace Fw.Application.Ams.Test.Mappings;

public class InvoiceMappingTest
{
    protected readonly IFixture _fixture;
    protected readonly IMapper _mapper;

    public InvoiceMappingTest()
    {
        ...
        config.Scan(Assembly.GetAssembly(typeof(InvoiceMapping)));
